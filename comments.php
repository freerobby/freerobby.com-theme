...
<?php if ( have_comments() ) : ?>
	...
	<h2><?php comments_number(__('No Responses',woothemes), __('One Response',woothemes), __('% Responses',woothemes) );?> to &#8220;<?php the_title(); ?>&#8221;</h2>
...
<?php else : // this is displayed if there are no comments so far ?>
	...
	<?php if ('open' == $post->comment_status) : ?>
	 ...
	 <?php else : // comments are closed ?>
		...
		<p class="nocomments"><?php _e('Comments are closed.',woothemes); ?></p>
