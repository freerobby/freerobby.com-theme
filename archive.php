<?php get_header(); ?>
		...
		<div id="content">
			...
			<?php if (is_category()) { ?>
            	...
            	<h2 class="result_heading"><?php _e('Archive',woothemes); ?> | <?php echo single_cat_title(); ?></h2>        
           	
				<?php } elseif (is_day()) { ?>
				<h2 class="result_heading"><?php _e('Archive',woothemes); ?> | <?php the_time('F jS, Y'); ?></h2>

				<?php } elseif (is_month()) { ?>
				<h2 class="result_heading"><?php _e('Archive',woothemes); ?> | <?php the_time('F, Y'); ?></h2>

				<?php } elseif (is_year()) { ?>
				<h2 class="result_heading"><?php _e('Archive',woothemes); ?> | <?php the_time('Y'); ?></h2>
			...
			<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				...
				<div class="post">
					...
					<div class="entry">
						...
						<p><a class="more-link" href="<?php the_permalink(); ?>" title="<?php _e('Read the full entry',woothemes); ?>"><?php _e('Continue Reading',woothemes); ?></a></p>
